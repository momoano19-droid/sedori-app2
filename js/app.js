...
const helpData = [
  ...
  },
  {
    title: "🔥 判断のコツ",
    content: `
      <b>迷った時は、まず期待値を見るのがおすすめです。</b><br><br>
      ・期待値3000円以上 → 行く価値あり<br>
      ・期待値10000円以上 → 強い店舗候補<br>
      ・成功率30%以上 → 安定しやすい<br>
      ・最終訪問が古い → 復活チェック候補<br>
      ・直近3回が弱い → 少し様子見<br>
      ・連敗が続く → 優先度を下げる<br><br>
      <b>基本は「期待値 × 成功率」で判断すると安定します。</b>
    `
  },
  {
    title: "🎨 色や表示の意味",
    content: `
      <b>カードの見た目にも意味があります。</b><br><br>
      ・成功率が高い → 色で強調表示<br>
      ・期待値が高い → 枠が強く表示<br>
      ・最終訪問が古い → カードが少し薄く表示<br><br>
      <b>つまり、見た目だけでもある程度判断できるようになっています。</b>
    `
  },
  {
    title: "🔘 ボタンの意味",
    content: `
      ...
      ・利益＋ → 利益を追加する<br>
      ・利益− → 利益を減らす<br>
      ・ナビ → Googleマップで案内を開く<br>
      ・座標再取得 → 店舗の位置情報を取り直す<br>
      ・設定 → 店舗情報やカテゴリを編集する<br>
      ・削除 → 店舗を削除する
    `
  },
  {
  ...
  },
  {
    ...
    content: `
      ...
      ② 「今日ルート作成」を押す<br>
      ③ Googleマップでルートを開く<br><br>
      <b>おすすめの使い方</b><br>
      朝に候補店舗へチェック → ルート作成 → そのまま回る
    `
  },
  {
    title: "🗺 店舗MAPの使い方",
    content: `
      <b>店舗MAPでは、登録店舗の位置をまとめて見られます。</b><br><br>
      ・期待値が高い店舗ほど目立ちやすい<br>
      ・位置のズレがある時は「座標再取得」<br>
      ・住所だけの店舗は地図機能が弱くなる場合があります<br><br>
      <b>住所とURLをしっかり入れておくと使いやすくなります。</b>
    `
  },
  {
    title: "📦 バックアップ",
    content: `
      ...
      ・大きく変更する前は保存推奨<br><br>
      <b>おすすめ</b><br>
      ・コード一式はGitHubやPCフォルダで保存<br>
      ・データは backup.json を保存<br><br>
      → この2つがあると、かなり安全です。
    `
  },
  {
    title: "✅ おすすめの使い方まとめ",
    content: `
      <b>最初はこの使い方がおすすめです。</b><br><br>
      ① よく行く店舗を全部登録<br>
      ② 行くたびに訪問＋<br>
      ③ 仕入れたら個数＋と利益＋<br>
      ④ 期待値順で並べる<br>
      ⑤ 強い店舗を優先して回る<br><br>
      <b>この流れを続けるほど、精度が上がっていきます。</b>
    `
  }
];
